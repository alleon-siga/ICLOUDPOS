    ...
    function margenUtilidad($action = '')
    {
        switch ($action) {
            case 'filter': {
                ...
                $data['lists'] = $this->reporte_venta_model->getMargenUtilidad($params);

                $this->load->view('menu/reporte_venta/margenUtilidad_list', $data);
                break;
            }
            case 'pdf': {
                $params = json_decode($this->input->get('data'));
                ...
                $data['lists'] = $this->reporte_venta_model->getMargenUtilidad($input);
                ...
                $html = $this->load->view('menu/reporte_venta/margenUtilidad_list_pdf', $data, true);
                $mpdf->WriteHTML($html);
                $mpdf->Output();
                break;
                break;
            ...
            case 'excel': {
                ...
                echo $this->load->view('menu/reporte_venta/margenUtilidad_list_excel', $data, true);
                break;
            }
            default: {
                if ($this->session->userdata('esSuper') == 1) {
                ...
                $dataCuerpo['cuerpo'] = $this->load->view('menu/reporte_venta/margenUtilidad', $data, true);
                if ($this->input->is_ajax_request()) {
                    echo $dataCuerpo['cuerpo'];
                } else {
                    $this->load->view('menu/template', $dataCuerpo);
    ...
    function utilidadProducto($action = '')
    {
        switch ($action) {
            case 'filter': {
                ...
                $data['lists'] = $this->reporte_venta_model->getUtilidadProducto($params);

                $this->load->view('menu/reporte_venta/utilidadProducto_list', $data);
                break;
            }
            case 'pdf': {
                $params = json_decode($this->input->get('data'));
                ...
                $data['lists'] = $this->reporte_venta_model->getUtilidadProducto($input);
                ...
                $this->load->library('mpdf53/mpdf');
                $mpdf = new mPDF('utf-8', 'A4-L', 0, '', 5, 5, 5, 5, 5, 5);
                $html = $this->load->view('menu/reporte_venta/utilidadProducto_list_pdf', $data, true);
                $mpdf->WriteHTML($html);
                $mpdf->Output();
                break;
            }
            case 'excel': {
                ...
                $data['local_nombre'] = !empty($local->local_nombre)? $local->local_nombre: 'TODOS';
                $data['local_direccion'] = !empty($local->direccion)? $local->direccion: 'TODOS';
                echo $this->load->view('menu/reporte_venta/utilidadProducto_list_excel', $data, true);
                break;
            }
            default: {
                if ($this->session->userdata('esSuper') == 1) {
                ...
                $dataCuerpo['cuerpo'] = $this->load->view('menu/reporte_venta/utilidadProducto', $data, true);
                if ($this->input->is_ajax_request()) {
                    echo $dataCuerpo['cuerpo'];
                } else {
                    $this->load->view('menu/template', $dataCuerpo);
