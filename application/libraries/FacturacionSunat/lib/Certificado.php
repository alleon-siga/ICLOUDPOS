 ...
 * Time: 12:35 PM
 */
require_once __DIR__.'/signature/XMLSecurityKey.php';
require_once __DIR__.'/signature/XMLSecurityDSig.php';
require_once __DIR__.'/signature/XMLSecEnc.php';

class Certificado
{
    // Firmo el Xml para su posterior envio
    public function firmarXml($flg_firma, $ruta, $ruta_firma, $pass_firma) {
        //flg_firma:
