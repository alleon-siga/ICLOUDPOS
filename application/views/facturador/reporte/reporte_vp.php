...
<ul class="breadcrumb breadcrumb-top">
    <li>Reporte</li>
    <li><a href="" > Ventas por Productos <span id="titulo_repor"></span></a></li>
</ul>
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    ...
                    <select name="estado_cr_id" id="estado_cr_id" class='ctrl form-control'>
                        <option value="0" selected="">Contable</option>
                        <option value="1" >Reales</option>
                    </select>
                </div>
                <div class="col-md-2">
                ...
                $(document).ready(function () {
                    ...
                    $("#btn_buscar, .btn_buscar").on("click", function () {
                        if ($("#tipo_reporte").val() == -1) {
                            $.bootstrapGrowl('<h4>Precaución.</h4> <p>Seleccione un tipo de reporte</p>', {
                                type: 'warning',
                                delay: 5000,
                                allow_dismiss: true,
                                align: "left"
