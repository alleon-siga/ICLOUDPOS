...
<table>
    ...
    <tr>
        <td style="font-weight: bold;text-align: center; font-size:1.5em; color: #000;"
            colspan="5"><?php if(isset($local_detalle)){
...
$html .= "<table border='1' bordercolor='#FFFFFF' cellpadding='1'cellspacing='0'>";
    if(isset($ingresos)) {
   ...
   $html .= " <tr><td align='center'>".$ingreso->id_ingreso."</td>";
        ...
        $html .="<td align='center' >" . date('d-m-Y H:i:s', strtotime($ingreso->fecha_registro)) . "</td>";
        $html .= "<td align='center'>";
