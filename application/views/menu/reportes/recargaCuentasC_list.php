...
<script type="text/javascript">
    ...
    function exportar_pdf() {
        ...
        var win = window.open('<?= base_url()?>reporte/recargaCuentasC/pdf?data=' + JSON.stringify(data), '_blank');
        win.focus();
    }
    ...
    function exportar_excel() {
        ...
        var win = window.open('<?= base_url()?>reporte/recargaCuentasC/excel?data=' + JSON.stringify(data), '_blank');
        win.focus();
    }
</script>