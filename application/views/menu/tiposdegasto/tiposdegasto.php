...
<ul class="breadcrumb breadcrumb-top">
    ...
    <li><a href="">Agregar y editar Tipos</a></li>
</ul>
<div class="row">
    <div class="col-xs-12">
...
<script type="text/javascript">
    ...
    function editar(id) {
        ...
        $("#agregar").load('<?= $ruta ?>tiposdegasto/form/'+id);
        $('#agregar').modal('show');
    }

    function agregar() {

        $("#agregar").load('<?= $ruta ?>tiposdegasto/form');
        $('#agregar').modal('show');
    }
...
<div class="modal fade" id="borrar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
    <form name="formeliminar" id="formeliminar" method="post" action="<?= $ruta ?>tiposdegasto/eliminar">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Est&aacute; seguro que desea eliminar el Tipo de Gasto seleccionado?</p>
