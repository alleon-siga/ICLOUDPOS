...
<div>
    <table cellpadding="0" cellspacing="10">
        ...
        <tr>
            <td style="border: 1px solid #0b0b0b;"><?= $datos[0]->origen ?></td>
            <td style="border: 1px solid #0b0b0b;"><?= $datos[0]->destino ?></td>
        </tr>
    </table>
    <br>
    ...
    <table style="border: 0px;" cellpadding="0" cellspacing="0">
        <tr>
            <td style="text-transform: uppercase;">
                Fecha: <?= date('d/m/Y h:i a', strtotime($datos[0]->fecha)) ?></td>
        </tr>
        <tr>
            <td style="text-transform: uppercase;">Vendedor: <?= $datos[0]->username ?></td>
        </tr>
    </table>
    <br>
