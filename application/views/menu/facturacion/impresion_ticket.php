...
<div>
    <table style="border: 0px;" cellpadding="0" cellspacing="0">
        <tr>
            <td style="text-transform: uppercase; text-align: center;"><?= $emisor->nombre_comercial != "-" && $emisor->nombre_comercial != "" ? $emisor->nombre_comercial : "" ?></td>
        </tr>
        <tr>
            <td style="text-transform: uppercase; text-align: center;"><?= $emisor->razon_social ?></td>
        </tr>
        <tr>
            <td style="text-transform: uppercase;">R.U.C.: <?= $emisor->ruc ?></td>
        </tr>
        <?php
        if (valueOption('EMPRESA_CONTACTO', '') != "-" && valueOption('EMPRESA_CONTACTO', '') != "") {
            ?>
            <tr>
        ...
        ?>
        <?php
        if (valueOption('EMPRESA_TELEFONO', '') != "-" && valueOption('EMPRESA_TELEFONO', '') != "") {
            ?>
            <tr>
                <td style="text-transform: uppercase; text-align: left;">
        ...
        ?>
        <?php
        if (valueOption('EMPRESA_CORREO', '') != "-" && valueOption('EMPRESA_CORREO', '') != "") {
            ?>
            <tr>
                <td style="text-transform: uppercase; text-align: left;">
        ...
        ?>
        <?php
        if ($emisor->direccion != "-" && $emisor->direccion != "") {
            ?>
            <tr>
                <td style="text-transform: uppercase; text-align: left;">
                    Direcci&oacute;n: <?= $emisor->direccion ?></td>
            </tr>
            <?php
        }
        ?>
