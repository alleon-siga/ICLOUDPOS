...
<div class="table-responsive">
    <table id="datatable" class="table dataTable table-bordered tableStyle">
        ...
        <tr>
            ...
            <th>Fec. Fact.</th>
            <th>Documento</th>
            <th><span data-toggle="tooltip" data-placement="top" title="Tipo Documento que Modifica">Doc. Mod.</span>
            </th>
            <th><span data-toggle="tooltip" data-placement="top"
                      title="Numero de Documento que Modifica">Nro. Doc.</span></th>
            <th><span data-toggle="tooltip" data-placement="top" title="Numero de Documento de Facturacion Electronica">Doc.</span>
            </th>
            <th>Nro. de Venta</th>
            <th>SubTotal</th>
            <th>Impuesto</th>
        ...
        <?php foreach ($lists as $list): ?>
            <tr class="info" style="font-weight: bold;">
                ...
                <td>
                    <span style="display: none;"><?= date('YmdHis', strtotime($list->Fec_Venta)) . $list->id ?></span>
                    <?= date('d/m/Y', strtotime($list->Fec_Venta)) ?>
                </td>
                <td>
                    <span style="display: none;"><?= date('YmdHis', strtotime($list->FecFacturacionElectr)) . $list->id ?></span>
                    <?= date('d/m/Y', strtotime($list->FecFacturacionElectr)) ?>
                </td>
